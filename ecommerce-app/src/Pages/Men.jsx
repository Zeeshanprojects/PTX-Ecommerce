  ...
  const products = [
    ...
    
    {
      ...
      colors: [
        ...
        { image: Image.Mineralwash9, hex: "#6B604F",name:"Pink" },
    ...
    },
    {
    ...
    },
     {
      ...
      fit: "Regular Fit",
      colors: [
        { image: Image.Short1, hex: "#DDD9D6",name:"Platinum" },
      ...
      price: 10.0,
      fit: "Regular Fit",
      colors: [{ image: Image.Shirt1, hex: "#4A0B0C",name:"Dark Sienna" }],
    },
       {
      title: "Hoodies",
      price: 10.0,
