    ...
    <>
      ...
      <div className="container-fluid p-0">
        <div className="row gx-1 gy-1">
          {[Image.bestselling1, Image.bestselling2, Image.bestselling3, Image.bestselling4,
            Image.bestselling6, Image.bestselling7, Image.bestselling8, Image.bestselling9
          ].map((imgSrc, idx) => (
