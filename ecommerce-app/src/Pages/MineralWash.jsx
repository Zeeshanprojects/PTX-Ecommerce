...
export default function Mineralwash() {
  useEffect(() => {
    document.title = "Mineralwash - PTX Ecommerce";
  }, []);
  ...
  const products = [
    {
      ...
      fit: "Regular Fit",
      colors: [
        { image: Image.Mineralwash1, hex: "#DDD9D6" },
        { image: Image.Mineralwash2, hex: "#DDD9D6" },
        { image: Image.Mineralwash3, hex: "#DDD9D6" },
        { image: Image.Mineralwash4, hex: "#DDD9D6" },
        { image: Image.Mineralwash5, hex: "#DDD9D6" },
        { image: Image.Mineralwash6, hex: "#DDD9D6" },
        { image: Image.Mineralwash7, hex: "#DDD9D6" },
        { image: Image.Mineralwash8, hex: "#DDD9D6" },
        { image: Image.Mineralwash9, hex: "#DDD9D6" },
        { image: Image.Mineralwash10, hex: "#DDD9D6" },
        { image: Image.Mineralwash11, hex: "#DDD9D6" },
        { image: Image.Mineralwash12, hex: "#DDD9D6" },
        { image: Image.Mineralwash13, hex: "#DDD9D6" },
        { image: Image.Mineralwash14, hex: "#DDD9D6" },
        { image: Image.Mineralwash15, hex: "#DDD9D6" },
        { image: Image.Mineralwash16, hex: "#DDD9D6" },
        { image: Image.Mineralwash17, hex: "#DDD9D6" },
        { image: Image.Mineralwash18, hex: "#DDD9D6" },
      ],
    },
  ];
